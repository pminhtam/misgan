...
class GenerateData(Dataset):
    ...
    def __init__(self, data_file):
        data = pandas.read_csv(data_file, delimiter="|", header=None)[[0,1,2,3,4,5]].head(50000).replace(np.nan, 0)
...
torch.save(data_gen.state_dict(), './data_gen_tpc_ds2.pt')
torch.save(mask_gen.state_dict(), './mask_gen_tpc_ds2.pt')
torch.save(imputer.state_dict(),  './imputer_tpc_ds2.pt')
