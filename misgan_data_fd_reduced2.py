...
class GenerateData(Dataset):
    ...
    def __init__(self, data_file):
        data = pandas.read_csv(data_file, delimiter=",", header=None, skiprows=1)[[3,4,5,6,7,14,15,16,17,18]].head(50000)
...
torch.save(data_gen.state_dict(), './data_gen_fd_reduced2.pt')
torch.save(mask_gen.state_dict(), './mask_gen_fd_reduced2.pt')
torch.save(imputer.state_dict(),  './imputer_fd_reduced2.pt')
