...
torch.save(data_gen.state_dict(), './model/data_gen_fd_reduced2.pt')
torch.save(mask_gen.state_dict(), './model/mask_gen_fd_reduced2.pt')
torch.save(imputer.state_dict(),  './model/imputer_fd_reduced2.pt')
