...
class GenerateData(Dataset):
    ...
    def __init__(self, data_file):
        self.data = pandas.read_csv(data_file, delimiter=",",header=None, skiprows=1)[[3,5,6,7,11,14,15,17,19,21,22,23]].head(50000).replace(np.nan, 0).values.astype(np.float32)
...
torch.save(data_gen.state_dict(), './data_gen_uce.pt')
torch.save(mask_gen.state_dict(), './mask_gen_uce.pt')
torch.save(imputer.state_dict(),  './imputer_uce.pt')
