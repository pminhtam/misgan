        ...
        for data_name1 in data_ori:
            for data_name2 in data_ori:
                ...
                for seq in name_data_real:
                    ...
                    data = np.genfromtxt("../data_new/"+data_name1+"_"+ data_name2 +"_"+ t +"_3col_part"+seq+ "_corr.csv", delimiter=",", filling_values=0)
                ...
                for seq in name_data_fake:
                    ...
                    data = np.genfromtxt("../data_new/"+data_name1 +"_fake_3col_part"+seq+ ".csv", delimiter=",", filling_values=0)
                    # data = np.genfromtxt("../gen_data/tpc_h_train_mul3.csv", delimiter=",", filling_values=0)
                    # print(data.shape)
                ...
                for seq in name_data_fake:
                    ...
                    # data = np.genfromtxt("../data_new/"+data_name +"_plus_3col_part"+seq+ ".csv", delimiter=",", filling_values=0)
                    data = np.genfromtxt("../data_new/"+data_name2 +"_fake_3col_part"+seq+ ".csv", delimiter=",", filling_values=0)
                    # data = np.genfromtxt("../gen_data/tpc_h_train_mul3.csv", delimiter=",", filling_values=0)
                    # print(data.shape)
